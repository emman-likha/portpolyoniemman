        ...
        >
            <div className="container mx-auto px-6 h-20 flex items-center justify-between">
                ...
                <a
                    ...
                    className="text-base md:text-xl font-bold tracking-tight text-foreground cursor-pointer flex items-center"
                >
                    <Image
                        src="/images/letter-e.png"
                        alt="E"
                        width={36}
                        height={36}
                        className="object-contain"
                    />
                    <span>mman&apos;s Portfolio</span>
                </a>
